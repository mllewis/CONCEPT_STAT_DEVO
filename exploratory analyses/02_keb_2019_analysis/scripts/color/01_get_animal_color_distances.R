...
DESC_COLORS <-  here("data/keb_reanalysis/words_to_cache.csv")
LANG_VECTORS <- here("data/keb_reanalysis/cached_vectors_kid.csv")
OUTPATH <- here("data/keb_reanalysis/animal_color_vectors_kid.csv")
