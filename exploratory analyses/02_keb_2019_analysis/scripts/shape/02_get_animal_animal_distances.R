...
LANG_DISTANCE_OUTPATH <- here("data/keb_reanalysis/animal_shape_distances_language_kid.csv")
SHAPE_SIM_PATH <- here("data/keb_reanalysis/animal_shape_vectors_kid.csv")
