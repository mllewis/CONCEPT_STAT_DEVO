...
LANG_DISTANCE_OUTPATH <- here("data/keb_reanalysis/animal_texture_distances_language_kid.csv")
TEXTURE_SIM_PATH <- here("data/keb_reanalysis/animal_texture_vectors_kid.csv")
